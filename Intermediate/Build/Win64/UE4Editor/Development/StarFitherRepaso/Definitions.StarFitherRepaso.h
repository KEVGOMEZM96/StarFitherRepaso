...
#define UE_PROJECT_NAME StarFitherRepaso
#define UE_TARGET_NAME StarFitherRepasoEditor
#define UE_MODULE_NAME "StarFitherRepaso"
...
#define STARFITHERREPASO_API DLLEXPORT
